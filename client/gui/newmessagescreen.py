...
class NewMessageScreen(gtk.ScrolledWindow, gui.Screen):
    ...
    def ok_button_function(self, event):
        ...
        text = shared.data.TextMessage(unicode(self.subject_entry.get_text()), unicode(self.buffer.get_text(self.buffer.get_start_iter(), self.buffer.get_end_iter(), True)), units, datetime.datetime.now())
        self.db.add(text)
