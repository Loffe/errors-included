...
class ServerManager(object):
    ...
    def __init__(self):
        ...
        self.messagedispatcher.connect_to_type(shared.data.MessageType.voip, self.voiphandler.voip_handler)
        self.messagedispatcher.connect_to_type(shared.data.MessageType.vvoip, self.voiphandler.vvoip_handler)
